...
export const CONCACAF_CHAMPIONS_CUP_METADATA: CompetitionDataMetadata = {
  ...
  notes: [
    ...
    '1978 决赛三角赛取消，瓜达拉哈拉大学、通信、国防军被宣布为并列冠军；当前仅瓜达拉哈拉大学已入库，并按 1/3 分摊冠军分。',
...
const RAW_CONCACAF_CHAMPIONS_CUP_RESULTS: RawConcacafChampionsCupResult[] = [
  ...
  { season: '1968', year: 1968, champion: '托卢卡体育' },
  ...
  { season: '1972', year: 1972, champion: '奥林匹亚体育', sourceRunnerUp: 'Robinhood' },
  ...
  { season: '1977', year: 1977, champion: '墨西哥美洲', sourceRunnerUp: 'Robinhood' },
  {
    ...
    note: '决赛三角赛取消，瓜达拉哈拉大学、通信、国防军被宣布为并列冠军；当前仅瓜达拉哈拉大学已入库，并按 1/3 分摊冠军分。'
  },
  ...
  { season: '1985', year: 1985, sourceChampion: 'Defence Force', runnerUp: '奥林匹亚体育' },
  ...
  { season: '1988', year: 1988, champion: '奥林匹亚体育', sourceRunnerUp: 'Defence Force' },
  ...
  { season: '1998', year: 1998, champion: '华盛顿联', runnerUp: '托卢卡体育' },
  { season: '1999', year: 1999, champion: '内卡萨', runnerUp: '阿拉胡埃拉人' },
  { season: '2000', year: 2000, champion: '洛杉矶银河', runnerUp: '奥林匹亚体育' },
  { season: '2002', year: 2002, champion: '帕丘卡', runnerUp: '莫雷利亚' },
  { season: '2003', year: 2003, champion: '托卢卡体育', runnerUp: '莫雷利亚' },
  { season: '2004', year: 2004, champion: '阿拉胡埃拉人', runnerUp: '萨普里萨' },
  { season: '2005', year: 2005, champion: '萨普里萨', runnerUp: '墨西哥美洲狮' },
  { season: '2006', year: 2006, champion: '墨西哥美洲', runnerUp: '托卢卡体育' },
  ...
  { season: '2011-12', year: 2012, champion: '蒙特雷', runnerUp: '桑托斯拉古纳' },
  { season: '2012-13', year: 2013, champion: '蒙特雷', runnerUp: '桑托斯拉古纳' },
  { season: '2013-14', year: 2014, champion: '蓝十字', runnerUp: '托卢卡体育' },
  ...
  { season: '2026', year: 2026, champion: '托卢卡体育', runnerUp: '新莱昂自治大学老虎' }
];
...
export const CONCACAF_CHAMPIONS_CUP_RESULTS: ConcacafChampionsCupResult[] =
  RAW_CONCACAF_CHAMPIONS_CUP_RESULTS.map((result) => ({
    ...
    championGroupKey: result.sourceChampions?.length ? result.season : null,
    championShare: result.sourceChampions?.length ?? null,
...
export function buildConcacafChampionsCupStandings(
  ...
  result.champions?.forEach((clubName, index) => {
    standings.push({
