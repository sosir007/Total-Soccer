...
const DATA_COMPLETENESS_UPDATED_AT_2026_09_14 = new Date('2026-09-14T00:00:00.000Z');
...
const COMPETITION_DATA_COMPLETENESS_BY_CODE = new Map<string, CompetitionDataCompleteness>([
  ...
  [
    ...
    {
      dataComplete: true,
      dataUpdatedAt: DATA_COMPLETENESS_UPDATED_AT_2026_08_27,
  ...
  [
    ...
    {
      dataComplete: true,
      dataUpdatedAt: DATA_COMPLETENESS_UPDATED_AT_2026_09_14,
      dataRemark: '2021-22 至 2025-26 已按决赛冠亚军完整录入；2026-27 赛季进行中。'
    }
  ],
  ['UEFA_CUP_WINNERS_CUP', COMPLETE_COMPETITION_DATA],
  [
...
function validateEditionStandings(
  ...
  switch (mode) {
    ...
    case CompetitionEditionStandingMode.LEAGUE_TOP_THREE:
      if (counts.runnerUp === 2 && counts.thirdPlace === 0) {
        assertCounts({ champion: 1, runnerUp: 2, thirdPlace: 0, fourthPlace: 0, semiFinalist: 0 });
        break;
      }
